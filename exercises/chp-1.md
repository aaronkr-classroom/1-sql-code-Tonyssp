...
데이터: 가공되지 않은 사실.
정보: 데이터에 의미를 부여하여 활용 가능하게 만든 것.

**12 정보 시스템의 구조와 종류를 설명하시오.**

구조: 하드웨어, 소프트웨어, 데이터, 네트워크, 사용자.
종류: TPS, MIS, DSS, ES 등.

**13 파일 정보 시스템 방식과 비교할 때 데이터베이스 시스템 방식이 갖는 장점은 무엇인지 설명하시오.**

데이터 중복 제거, 무결성 유지, 보안 강화, 확장성 높음, 처리 효율성 증가.

**14 시대별 데이터베이스 시스템의 성장 과정을 개략적으로 설명하시오.**

- 1960년대: 파일 기반 시스템.

- 1970년대: 관계형 데이터베이스(RDBMS) 도입.

  이후: 빅데이터와 NoSQL 기술 발전

**15 좁은 의미의 데이터베아스를 정의하시오.**

데이터를 체계적으로 저장하고 관리하는 구조.
